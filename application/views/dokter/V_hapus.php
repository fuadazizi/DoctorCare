 ...
 <head>
    ...
    <title>Hapus Jadwal Kosong</title>
</head>
<body>
    ...
    <tbody>
        <tr><?php foreach ($jadwaltemu as $jt) : ?>
            ...
            <td class="text-center">
                <a href="<?= base_url(); ?>C_Dokter/V_hapus/<?= $jt['id'] ?>" class="badge badge-danger float-center" onclick="return confirm('Apakah anda yakin menghapus data ini?');" ?>hapus</a>
            </td>
        </tr>
        <?php endforeach ?>
    </tbody>
