            ...
            <table id="table_id" class="table table-bordered table table-hover">
                ...
                <tbody>
                    ...
                    foreach ($dokter as $Dokter) {
                          if ($Dokter->username == $this->session->userdata('session_username')) {
                    ?>
                    <tr>
                            <th width="600px">Nama</th>
                            <th><?php echo $Dokter->nama ;?></th>
                    </tr>
                    <tr>
                            <th>Jenis Kelamin</th>
                            <th><?php echo $Dokter->jeniskelamin ;?></th>
                    </tr>
                    <tr>
                            <th>Alamat</th>
                            <th><?php echo $Dokter->alamat ;?></th>
                    </tr>
                    <tr>
                            <th>Spesialis</th>
                            <th><?php echo $Dokter->spesialis ;?></th>
                    </tr>
                    <tr>
                            <th>Email</th>
                            <th><?php echo $Dokter->email ;?></th> 
                    </tr>
                    <tr>
                            <th>Telepon</th>
